...
def main():
    ...
    llm_generators = {
        "Phi3_mini_no_rephrasing": "outputs/run_outputs/GSM8K/Phi-3-mini-4k-instruct/2025-08-07_18-38-24---[rStar_GSM8K_Phi-3_mini_no_rephrasing]",
    ...
    # Save results
    output_filename = f"llm_answers_discriminator_{question_range[0]}_{question_range[1]-1}_temp.json"
